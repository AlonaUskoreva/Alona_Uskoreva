...
namespace Alona_Uskoreva
{
	class kordamine
	{
        static int Saali_suurus()
        {
            Console.WriteLine("Vali saali suurus: 1,2,3");//salvestab teie broneeritud toa suuruse
        ...
        static void Saal_ekraanile()
        {
            ...
            Console.WriteLine();// Kirjutab määratud andmed koos praeguse rea lõpetajaga standardsesse väljundvoogu
            for (int rida = 0; rida < read; rida++)
            {
